...
\end{align*}
Die erste Zeile gibt die Größe der Channels in dem Programm an. Die restlichen Zeichen 
geben den eigentlichen Trace an, aus dem der Aublauf des Programms eindeutig rekonstruiert 
werden kann.
\extend{Tracer}
