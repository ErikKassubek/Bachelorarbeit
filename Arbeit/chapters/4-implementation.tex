...
Zur Suche nach alternativen Kommunikationspartner werden alle Kombinationen
...
ungebuffert ist und die Pre- oder die Vectorclocks der beiden 
...
nicht unvergleichbar sein. 
\todo{Kommunikationspartner für gebufferte Channelt}
\todo{Nachricht wird erzeugt}
...
\todo{Beispiel zu Ausgabe zu show mit selece}