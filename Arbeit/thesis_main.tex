...
\usepackage{titling}
\title{Dynamic Analysis of Concurrent Go Programs}
...
\begin{document}
    ...
    \input{chapters/2_1-detector.tex}
    \input{chapters/3-instrumentation.tex}
    \input{chapters/4-implementation.tex}
    \input{chapters/5-evaluation.tex}
    \input{chapters/6-conclusions.tex}
    % \input{chapters/7-acknowledgments.tex}
    \input{chapters/8-appendix.tex}
    \listoffigures
    \listoftables
    % \listofalgorithms
    % \lstlistoflistings
