...
\begin{frame}{Detektion von Deadlocks: Lock-Bäume}
  ...
  \begin{minipage}{0.25\textwidth}
      \begin{tikzpicture}[node distance={12mm}, thick, main/.style = {draw}] 
          \node[main, draw=Red1, text=Red1, rectangle, visible on=<2>] (R1) {R1};
          \node[main, rectangle, visible on=<3->] (R1) {R1};

          \node[main, draw=Red1, text=Red1, circle, visible on=<3-4>] [below of=R1](y1) {y}; 
          \node[main, circle, visible on=<5->] [below of=R1](y1) {y}; 


          \node[main, draw=Red1, text=Red1, circle, visible on=<3>] [below of=y1](z1) {z};
          \node[main, circle, visible on=<4->] [below of=y1](z1) {z};

          \node[main, draw=Red1, text=Red1, circle, visible on=<4>] [right of=z1](x1) {x};
          \node[main, circle, visible on=<5->] [right of=z1](x1) {x};


          \node[main, draw=Red1, text=Red1, rectangle, visible on=<2>] [below of=z1](R2) {R2};
          \node[main, rectangle, visible on=<3->] [below of=z1](R2) {R2};

          \node[main, draw=Red1, text=Red1, circle, visible on=<5>] [below of=R2](z2) {x};
          \node[main, circle, visible on=<6->] [below of=R2](z2) {x};

          \node[main, draw=Red1, text=Red1, circle, visible on=<5>] [below of=z2](x2) {z};
          \node[main, circle, visible on=<6->] [below of=z2](x2) {z};


          \node[main, draw=Red1, text=Red1, rectangle, visible on=<2>] [below of=x1](R3) {R3};
          \node[main, rectangle, visible on=<3->] [below of=x1](R3) {R3};

          \node[main, draw=Red1, text=Red1, circle, visible on=<6>] [below of=R3](x3) {z};
          \node[main, circle, visible on=<7->] [below of=R3](x3) {z};

          \node[main, draw=Red1, text=Red1, circle, visible on=<6>] [below of=x3](y3) {y};
          \node[main, circle, visible on=<7->] [below of=x3](y3) {y};


          \draw[->, draw=Red1, visible on=<3>] (R1) to (y1);
          \draw[->, visible on=<4->] (R1) to (y1);
          

          \draw[->, draw=Red1, visible on=<4>] (y1) to (x1);
          \draw[->, draw=Red1, visible on=<7>] (y1) to (x1);
          \draw[->, visible on=<5-6>] (y1) to (x1);

          \draw[->, draw=Red1, visible on=<3>] (y1) to (z1);
          \draw[->, visible on=<4->] (y1) to (z1);

          \draw[->, draw=Red1, visible on=<5>] (R2) to (z2);
          \draw[->, visible on=<6->] (R2) to (z2);

          \draw[->, draw=Red1, visible on=<5>] (z2) to (x2);
          \draw[->, draw=Red1, visible on=<7>] (z2) to (x2);
          \draw[->, visible on=<6>] (z2) to (x2);


          \draw[->, draw=Red1, visible on=<6>] (R3) to (x3);
          \draw[->, visible on=<7->] (R3) to (x3);

          \draw[->, draw=Red1, visible on=<6>] (x3) to (y3);
          \draw[->, draw=Red1, visible on=<7>] (x3) to (y3);


          \draw[dashed, draw=Red1, ->, visible on=<7>] (x1) to [out=180+45,in=45] (z2);
          \draw[dashed, draw=Red1, ->, visible on=<7>] (x2) to [out=45,in=180+45] (x3);
          \draw[dashed, draw=Red1, ->, visible on=<7>] (y3) to [out=45,in=0,looseness=1.4] (y1);
      \end{tikzpicture}
  \end{minipage}
\end{frame}
...
\begin{frame}{Analyse - Channel}
  ...
  \begin{tikzpicture}[overlay]
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<1>] at (-4.0, 5.80) (1) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<1>] at (-2.4, 5.80) (2) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<1>] at (-0.7, 5.80) (3) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-2>] at (-4.0, 4.84) (4) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-2>] at (-2.4, 4.84) (5) {};
    \node[fill= white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-3>] at (-4.0, 3.885) (6) {};
    \node[fill= white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-3>] at (-0.8, 3.885) (7) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-4>] at (-4.0, 2.93) (8) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-4>] at (-2.4, 2.93) (9) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-5>] at (-4.0, 1.97) (10) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-5>] at (-2.4, 1.97) (11) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-6>] at (-2.4, 1.01) (12) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-6>] at (-0.8, 1.01) (13) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-7>] at (-0.8, 0.05) (14) {};
    \node[fill=white, rectangle, minimum width=0.7cm, minimum height=0.04cm, visible on=<-7>] at (-2.4, 0.05) (15) {};
\end{tikzpicture}
  \end{minipage}
  \hfill
  \uncover<9>{\vrule{}}
