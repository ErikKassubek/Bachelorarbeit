...
\title[Dynamic Analysis of Go-Programs]{Dynamic Analysis of Message Passing Go-Programs}
...
\begin{frame}{RWMutex}
  \lstinputlisting{code/mutex-rw.txt}
\end{frame}

\begin{frame}{Mutex: Zyklisches Locking}
  \lstinputlisting{code/mutex-zyclic.txt}
\end{frame}

\begin{frame}{Mutex: Doppeltes Locking}
  \lstinputlisting{code/mutex-double.txt}  
\end{frame}
...
\begin{frame}{Channel - unbuffered}
  ...
  \hfill
  \begin{minipage}{0.49\textwidth}
    \lstinputlisting{code/channel-un-block.txt}
  \end{minipage}
\end{frame}
